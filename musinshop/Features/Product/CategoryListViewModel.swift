...
//    @Published private(set) var categoryList: [Category] = []
    @Published private(set) var categoryList: [Category] = [
        ...
        Category(id: 10, name: "운동화", parentId: 9, children: nil),
        Category(id: 11, name: "구두", parentId: 9, children: nil),
        Category(id: 12, name: "구두", parentId: 1, children: nil),
        Category(id: 13, name: "구두", parentId: 1, children: nil),
        Category(id: 14, name: "구두", parentId: 1, children: nil),
        Category(id: 15, name: "구두", parentId: 1, children: nil),
        Category(id: 16, name: "구두", parentId: 1, children: nil),
        Category(id: 17, name: "구두", parentId: 1, children: nil)
    ]
